...
<!-- ======= Hero Section ======= -->
<section id="hero-prodi-sk" class="d-flex align-items-center">
    <div class="container">
        <h1>D3 <br> Seni Kuliner</h1>
    ...
    <section id="tentang" class="tentang">
        <div class="container">
            <div class="section-title">
                <h2>Tentang Prodi Seni Kuiner</h2>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <img src="/assets/img/prodi/tentang-sk.JPG" class="img-fluid" alt="">
                    <h2>Apa itu Prodi Seni Kuliner?</h2>
                    <p>Menghasilkan lulusan dengan keterampilan dan kemampuan di bidang kerja baik di hotel, restaurant, ataupun di kantor swasta terutama di sektor pariwisata.
                    </p>
                </div>
                <div class="col-lg-4">
    ...
    <section id="profil" class="profil-lulusan">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title">
                        <h2>Profil Lulusan <br> D3 Seni Kuiner</h2>
                    </div>
                    <div class="row">
                        <div class="col">
                            <h3>Masa Studi:</h3>
