...
<!-- ======= Hero Section ======= -->
<section id="hero-prodi-pw" class="d-flex align-items-center">
    <div class="container">
        <h1>D3 <br> Perjalanan Wisata</h1>
    ...
    <section id="tentang" class="tentang">
        <div class="container">
            <div class="section-title">
                <h2>Tentang Prodi Perjalanan Wisata</h2>
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <img src="/assets/img/prodi/tentang-pw.JPG" class="img-fluid" alt="">
                    <h2>Apa itu Perjalanan Wisata?</h2>
                    <p>Mempelajari tentang manajemen pariwisata, geografi pariwisata mancanegara, dan aspek" pendukungnya.
                    </p>
                </div>
                <div class="col-lg-4">
                    <div class="card" style="width: 18rem;">
                        <img src="/assets/img/dosen/pak-imam.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Imam Ozali, AMTru, M.M</h5>
                            <p class="card-text">Kaprodi Perjalanan Wisata</p>
    ...
    <section id="profil" class="profil-lulusan">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title">
                        <h2>Profil Lulusan <br> D3 Perjalanan Wisata</h2>
                    </div>
                    <div class="row">
                        <div class="col">
                            <h3>Masa Studi:</h3>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <ul class="list-unstyled mb-0 col-12 col-md-8 text-dark-l1 text-90 text-left my-4 my-md-0">
                                                <li>
                                                    ...
                                                    <span>
                                                        <span class="text-white">
                                                            Staf Perusahaan Penerbangan (Ticketing, Customer Service, Call Center)
                                                        </span>
                                                    </span>
                                                </li>
                                                ...
                                                <li class="mt-25">
                                                    <i class="fa fa-check text-white  mr-2 mt-1"></i>
                                                    <span class="text-white">
                                                        Staf Bandara (Passenger Handling, Ground Handling)
                                                    </span>
                                                </li>
                                                <li class="mt-25">
                                                    <i class="fa fa-check text-white  mr-2 mt-1"></i>
                                                    <span class="text-white">
                                                        Staf Logistik & Kargo Bandara
                                                    </span>
                                                </li>
                                                <li class="mt-25">
                                                    <i class="fa fa-check text-white  mr-2 mt-1"></i>
                                                    <span class="text-white">
                                                        Staf Biro Perjalanan Wisata (Travel Consultant)
                                                    </span>
                                                </li>
                                                <li class="mt-25">
                                                    <i class="fa fa-check text-white  mr-2 mt-1"></i>
                                                    <span class="text-white">
                                                        Pemandu Wisata (Tour Guide, Tour Leader, Tour Planner)
                                                    </span>
                                                </li>
                                                <li class="mt-25">
                                                    <i class="fa fa-check text-white  mr-2 mt-1"></i>
